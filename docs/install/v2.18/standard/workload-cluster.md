...
You need a management-cluster kubeconfig, an existing workspace, a supported node
image, reserved IP addresses, Nutanix infrastructure names, and registry details.
...
!!! tip "Field note: inspect conditions first"
    If provisioning stalls, describe the `Cluster`, `Machine`, and
    `NutanixMachine` resources before troubleshooting individual VMs.

## Next step

[Create a project](project.md) for application teams.
